...
var slideMover = function(){
	if(active >= slider.length){
  	...
  	sliderWrapper.style.height = screenHeight+'px';
  	screenSize = window.getComputedStyle(slider[0]);
	imgWidth = parseInt(screenSize.getPropertyValue('width'));
...
var testScroll = function(){
	var element = document.getElementsByClassName("up-arrow")[0];
	var heightValue = window.scrollY;
	if(heightValue<5){
